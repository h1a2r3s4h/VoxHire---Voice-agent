  ...
  return (
    <div className="min-h-screen bg-[#f5f5f5] px-6 py-6 md:px-10">
      ...
      <div className="mt-10 flex flex-col items-center">
        ...
        {/* Title */}
        <h1 className="mt-6 text-center text-4xl font-extrabold text-foreground md:text-5xl">
          Interview Complete!
        </h1>
        ...
        {/* Interview Image */}
        <div className="mt-8 w-full max-w-5xl overflow-hidden rounded-3xl bg-card shadow-lg shadow-black/50">
          <Image
        ...
        {/* What's Next Card */}
        <div className="mt-10 w-full max-w-2xl rounded-2xl bg-card px-8 py-10 text-center shadow-md">
          <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-full bg-blue-500">
            <Send className="h-8 w-8 text-white" />
          </div>

          <h2 className="mt-6 text-3xl font-bold text-foreground">What&apos;s Next?</h2>
